          ...
          <div class="centrat">
            ...
            <div id="lateral">
              <ul>Per tema
                ...
                <li class="actv"><a href="ciutat.xml">Ciutat i espai públic</a></li>
            ...
            <div id="contingut">
              <xsl:for-each select="cccb/expo">
                <xsl:if test="tema00='Ciutat i espai públic' or tema01='Ciutat i espai públic' or tema02='Ciutat i espai públic' or tema03='Ciutat i espai públic'">
                  <div class="bloc">
