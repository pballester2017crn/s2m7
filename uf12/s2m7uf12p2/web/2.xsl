      ...
      <body>
        ...
        <div id="principal">
          <div class="centrat">
            ...
            <div id="contingut">
              <xsl:for-each select="cccb/expo[2]">
                <div class="bloc">
                    ...
                    <img src="{image}"/>
                    <ul id="aside">
                      <li class="cat"><xsl:value-of select="categoria"/></li>
                      <li class="cat"><xsl:value-of select="tema00"/></li>
                      <li class="cat"><xsl:value-of select="tema01"/></li>
                      <li class="cat"><xsl:value-of select="tema02"/></li>
                      <li class="cat"><xsl:value-of select="tema03"/></li>
                      <li>Horari</li>
                      <li class="cat"><xsl:value-of select="horari"/></li>
                      <li>Preu</li>
                      <li class="cat"><xsl:value-of select="preu"/></li>
                      <li>Espai</li>
                      <li class="cat"><xsl:value-of select="espai"/></li>
                    </ul>
                    <div id="text">
                      <div id="enlla">
                        <p><xsl:value-of select="enllaç"/></p>
                      </div>
                      <div id="txt">
                        <p><xsl:value-of select="destacat"/></p>
