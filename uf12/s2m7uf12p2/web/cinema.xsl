          ...
          <div class="centrat">
            ...
            <div id="lateral">
              <ul>Per tema
                ...
                <li class="actv"><a href="cinema.xml">Cinema i audiovisuals</a></li>
            ...
            <div id="contingut">
              <xsl:for-each select="cccb/expo">
                <xsl:if test="tema00='Cinema i audiovisuals' or tema01='Cinema i audiovisuals' or tema02='Cinema i audiovisuals' or tema03='Cinema i audiovisuals'">
                  <div class="bloc">
